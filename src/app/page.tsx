...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      buttons={[
        {
          text: "تصفح العقارات",          href: "#listings"},
        {
  ...
  <div id="about" data-section="about">
      ...
      metrics={[
        {
          value: "٥٠٠+",          title: "عقار متميز"},
        {
          value: "١٠+",          title: "سنوات خبرة"},
        {
          value: "١٠٠٠+",          title: "عميل سعيد"},
      ]}
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          title: "استشارات خبراء",          description: "تحليل دقيق للسوق وأفضل النصائح الاستثمارية.",          icon: Shield,
          mediaItems: [
            {
        ...
        {
          title: "شفافية مطلقة",          description: "نضمن لك عقوداً سليمة وإجراءات قانونية موثقة.",          icon: Zap,
          mediaItems: [
            {
        ...
        {
          title: "تغطية شاملة",          description: "تغطية لأهم المناطق والمدن في الجزائر.",          icon: Star,
          mediaItems: [
            {
  ...
  <div id="listings" data-section="listings">
      ...
      products={[
        {
          id: "1",          name: "فيلا فاخرة - العاصمة",          price: "١٥٠,٠٠٠,٠٠٠ دج",          variant: "فيلا",          imageSrc: "http://img.b2bpic.net/free-photo/beautiful-castle-interior-design_23-2151010548.jpg"},
        {
          id: "2",          name: "شقة حديثة - وهران",          price: "٢٥,٠٠٠,٠٠٠ دج",          variant: "شقة",          imageSrc: "http://img.b2bpic.net/free-photo/friends-eating-pizza-together-house-steps_23-2148219031.jpg"},
        {
          id: "3",          name: "منزل عائلي - قسنطينة",          price: "٣٠,٠٠٠,٠٠٠ دج",          variant: "منزل",          imageSrc: "http://img.b2bpic.net/free-photo/happy-couple-resting-home-cozy-sofa_7502-9284.jpg"},
        {
          id: "4",          name: "استوديو عصري - عنابة",          price: "١٢,٠٠٠,٠٠٠ دج",          variant: "استوديو",          imageSrc: "http://img.b2bpic.net/free-photo/gates-city-cloudy-day_1268-14466.jpg"},
        {
          id: "5",          name: "أرض للبناء - سطيف",          price: "٨,٠٠٠,٠٠٠ دج",          variant: "أرض",          imageSrc: "http://img.b2bpic.net/free-photo/luxury-holiday-home_23-2151918251.jpg"},
        {
          id: "6",          name: "شقة دوبلكس - البليدة",          price: "٤٥,٠٠٠,٠٠٠ دج",          variant: "دوبلكس",          imageSrc: "http://img.b2bpic.net/free-photo/beach-chair-resort_1150-17976.jpg"},
      ]}
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        {
          id: "m1",          value: "٩٨٪",          title: "رضا العملاء",          items: [
            "خدمة متميزة",            "دعم مستمر",            "ثقة متبادلة"],
        },
        {
          id: "m2",          value: "٥٠٠+",          title: "مشاريع ناجحة",          items: [
            "بناء",            "بيع",            "استثمار"],
        },
        {
          id: "m3",          value: "١٥٠٠+",          title: "استشارة مجانية",          items: [
            "تخطيط",            "تحليل",            "حلول"],
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        {
          id: "1",          name: "سارة أحمد",          handle: "مستثمرة",          testimonial: "خدمة ممتازة واحترافية عالية في التعامل مع العقارات.",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/high-angle-smiley-business-male_23-2148479546.jpg"},
        {
          id: "2",          name: "محمد خليل",          handle: "مالك منزل",          testimonial: "لقد ساعدوني في إيجاد منزلي المثالي في وقت قياسي.",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-confident-man-home-office_329181-20664.jpg"},
        {
          id: "3",          name: "ليلى بلقاسم",          handle: "مستشارة",          testimonial: "شفافية مطلقة ومصداقية في كل تفاصيل العقد.",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/cheerful-caucasian-guy-dating-afro-american-girl_1262-19996.jpg"},
        {
          id: "4",          name: "ياسين عماري",          handle: "رجل أعمال",          testimonial: "أفضل خيار للاستثمار العقاري الموثوق في الجزائر.",          rating: 5,
        ...
        {
          id: "5",          name: "مريم نوري",          handle: "مهندسة",          testimonial: "تجربة شراء سهلة وآمنة بفضل خبرة الفريق.",          rating: 5,
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "f1",          title: "كيف أبدأ الاستثمار العقاري؟",          content: "يمكنك البدء بالاتصال بنا للحصول على استشارة أولية مجانية وتحليل للسوق."},
        {
          id: "f2",          title: "ما هي الأوراق المطلوبة؟",          content: "نحن نساعدك في تجهيز كافة الأوراق القانونية اللازمة لضمان سلامة عقد الملكية."},
        {
          id: "f3",          title: "هل تقدمون خدمات التمويل؟",          content: "لدينا شراكات مع البنوك لمساعدتك في خيارات التمويل المتاحة."},
      ]}
      title="أسئلة شائعة"
